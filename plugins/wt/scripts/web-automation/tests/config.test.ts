...
describe('config', () => {
    ...
    describe('validateConfig', () => {
        ...
        it('should fail on wrong type', () => {
            ...
            const rules: ConfigValidationRule[] = [{ key: 'count', type: 'number' }];
        ...
        it('should check array type', () => {
            ...
            const rules: ConfigValidationRule[] = [{ key: 'items', type: 'array' }];
        ...
        it('should check object type', () => {
            ...
            const rules: ConfigValidationRule[] = [{ key: 'settings', type: 'object' }];
        ...
        it('should fail custom validator', () => {
            ...
            const rules: ConfigValidationRule[] = [{ key: 'value', validate: (v) => typeof v === 'number' && v < 20 }];
            ...
            const rules: ConfigValidationRule[] = [
                {
                    key: 'value',
                    type: 'number',
                    validate: (v) => typeof v === 'number' && v < 20,
        ...
        it('should handle NaN for number type', () => {
            ...
            const rules: ConfigValidationRule[] = [{ key: 'value', type: 'number' }];
