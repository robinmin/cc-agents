...
import { LogLevel, Logger, LoggerOptions, createLogger, parseLogLevel, getDefaultLogLevel } from '../src/logger.js';
        ...
        describe('error()', () => {
            ...
            it('should include error details in metadata', () => {
                ...
                const testCall = calls.find(
                    (call: unknown[]) => call[0] && typeof call[0] === 'string' && call[0].includes('test-metadata'),
                );
                if (testCall) {
