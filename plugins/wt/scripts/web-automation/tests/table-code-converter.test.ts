...
class MockCdpConnection implements CdpConnection {
  async send<T = unknown>(_method: string, _params?: Record<string, unknown>, _options?: { sessionId?: string; timeoutMs?: number }): Promise<T> {
    return {} as T;
  }
}
