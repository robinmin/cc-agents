...
describe('fs', () => {
    ...
    describe('safeWriteFile', () => {
        ...
        it('should throw FileValidationError on error', async () => {
            ...
            await expect(safeWriteFile(invalidPath, 'content')).rejects.toThrow(FileValidationError);
        });
    });
    ...
    describe('safeReadFile', () => {
        ...
        it('should throw FileValidationError for non-existent file', async () => {
            ...
            await expect(safeReadFile(filePath)).rejects.toThrow(FileValidationError);
        });
    });
    ...
    describe('safeAppendFile', () => {
        ...
        it('should throw FileValidationError on error', async () => {
            ...
            await expect(safeAppendFile(invalidPath, 'content')).rejects.toThrow(FileValidationError);
        });
    });
    ...
    describe('processStream', () => {
        ...
        it('should handle stream error', async () => {
            ...
            await expect(processStream(stream, () => {})).rejects.toThrow('Stream error');
        });
    ...
    describe('copyFile', () => {
        ...
        it('should throw FileValidationError on source error', async () => {
            ...
            await expect(copyFile(sourcePath, destPath)).rejects.toThrow(FileValidationError);
        });
    });
    ...
    describe('getFileSize', () => {
        ...
        it('should throw FileValidationError for non-existent file', async () => {
            ...
            await expect(getFileSize(filePath)).rejects.toThrow(FileValidationError);
        });
    });
