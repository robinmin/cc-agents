...
export function getPlatformConfig(options: ConfigOptions = {}): PlatformConfig {
    const { configPath = getDefaultConfigPath(), platform, envVar, cacheTtlMs = DEFAULT_CACHE_TTL_MS } = options;
 ...
 */
export function getConfigValue<T>(key: string, defaultValue: T, options: ConfigOptions = {}): T {
 ...
 */
export function getStringConfig(key: string, defaultValue: string, options: ConfigOptions = {}): string {
 ...
 */
export function getBooleanConfig(key: string, defaultValue: boolean, options: ConfigOptions = {}): boolean {
 ...
 */
export function getNumberConfig(key: string, defaultValue: number, options: ConfigOptions = {}): number {
 ...
 */
export function getArrayConfig<T>(key: string, defaultValue: T[], options: ConfigOptions = {}): T[] {
