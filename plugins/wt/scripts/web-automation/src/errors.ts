...
export class UrlValidationError extends ValidationError {
    constructor(url: string, reason = 'Invalid URL', context?: Record<string, unknown>) {
...
export class FileValidationError extends ValidationError {
    constructor(filePath: string, reason = 'Invalid file', code = 'INVALID_FILE', context?: Record<string, unknown>) {
...
export class FileSizeError extends FileValidationError {
    ...
    constructor(filePath: string, maxSize: number, actualSize: number, context?: Record<string, unknown>) {
...
export class FileFormatError extends FileValidationError {
    ...
    constructor(filePath: string, allowedFormats: readonly string[], context?: Record<string, unknown>) {
 ...
 */
export function wrapError(err: unknown, code: string, message?: string): WtAutomationError {
    if (isWtAutomationError(err)) {
        return err;
    }
