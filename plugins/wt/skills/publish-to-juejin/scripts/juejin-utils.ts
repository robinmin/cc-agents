...
interface JuejinConfig {
  profile_dir?: string;
  auto_publish?: boolean;
}

/**
 * Get Juejin config from WT config
 */
export function getJuejinConfig(): JuejinConfig {
  const wtConfig = getWtConfig();
  return (wtConfig['publish-to-juejin'] as JuejinConfig) || {};
}
