 ...
 */
export async function createArticle(projectPath: string, articleName: string): Promise<string> {
 ...
 */
export function updateArticleContent(articlePath: string, article: ParsedArticle): void {
    let frontmatter = '---\n';
 ...
 * Publish article
 */
export async function publishArticle(projectPath: string, articleName: string, force = false): Promise<void> {
