...
type TokenRenderer = (token: Tokens.Generic) => string;
...
function inlineKatex(options: MarkedKatexOptions | undefined, renderer: TokenRenderer) {
...
function blockKatex(_options: MarkedKatexOptions | undefined, renderer: TokenRenderer) {
    return {
        name: `blockKatex`,
        level: `block`,
        tokenizer(src: string) {
...
function inlineLatexKatex(_options: MarkedKatexOptions | undefined, renderer: TokenRenderer) {
    return {
...
function blockLatexKatex(_options: MarkedKatexOptions | undefined, renderer: TokenRenderer) {
    return {
...
export function MDKatex(options: MarkedKatexOptions | undefined, withStyle = true): MarkedExtension {
    return {
        extensions: [
