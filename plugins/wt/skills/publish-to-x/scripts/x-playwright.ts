...
import { copyImageToClipboard, getAutoSubmitPreference, getDefaultProfileDir } from './x-utils.js';
...
const BUTTON_SELECTORS = ['[data-testid="tweetButton"]', '[role="button"][tabindex="0"]', 'button[type="button"]'];
