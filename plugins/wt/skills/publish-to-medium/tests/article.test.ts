...
Some content here.`;
	...
	describe("HTML parsing", () => {
		test("should extract title from <title> tag", () => {
			const html =
				"<html><head><title>My HTML Article</title></head><body>Content</body></html>";
...
Content here`;
	...
	describe("HTML file validation", () => {
		...
		test("should accept HTML with title tag", () => {
			...
			try {
				const content =
					"<html><head><title>Valid HTML Title</title></head><body>Content</body></html>";
	...
	describe("publish status validation", () => {
		test("should accept valid publish status values", () => {
			...
			validStatuses.forEach((status) => {
				const isValid =
					status === "public" || status === "draft" || status === "unlisted";
		...
		test("should reject invalid publish status", () => {
			...
			const isValid =
				invalidStatus === "public" ||
				invalidStatus === "draft" ||
				invalidStatus === "unlisted";
