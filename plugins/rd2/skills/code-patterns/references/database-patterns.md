...
This reference provides production-ready patterns for database operations including migrations, queries, indexing, and ORM usage. Use these patterns when designing database schemas, optimizing queries, or implementing data access layers.
