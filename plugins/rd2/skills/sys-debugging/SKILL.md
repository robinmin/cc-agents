...
> **For complete, step-by-step debugging walkthroughs with real code examples demonstrating these scenarios, see EXAMPLES.md.**
...
- **rd2:testing-patterns**: Create test that reproduces the bug before fixing
- **rd2:code-review**: Review fix for unintended side effects before committing
- **rd2:10-stages-developing**: Use TDD workflow for implementing the fix

## Reference Files

- See EXAMPLES.md for complete debugging walkthroughs with real code
