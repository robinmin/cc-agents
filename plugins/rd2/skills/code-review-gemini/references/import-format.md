...
|-------|------|----------|-------------|---------|
| `type` | string | No | Review type identifier | `gemini-code-review` |
| `model` | string | No | Model used for review | `gemini-3-flash-preview` |
...
python3 code-review-gemini.py import review.md

# Import only critical
python3 code-review-gemini.py import review.md --priority critical

# Import only high
python3 code-review-gemini.py import review.md --priority high
```
...
- `gemini-flags.md` - Gemini CLI flags reference
