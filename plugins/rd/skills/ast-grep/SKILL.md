---
name: ast-grep
description: Write ast-grep rules for structural code search and analysis. Use when searching codebases using Abstract Syntax Tree (AST) patterns, finding specific code structures, or performing complex code queries beyond simple text search.
---
