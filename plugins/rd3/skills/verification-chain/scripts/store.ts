...
function serializeNodeRecord(state: ChainState, node: NodeExecutionState, ordinal: number): NodeRecord {
    return {
...
function serializeEvidenceRecords(state: ChainState, node: NodeExecutionState): EvidenceRecord[] {
