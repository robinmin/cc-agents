            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <div
                                className={`w-3 h-3 rounded-full transition-colors ${previewMode === 'live' ? 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.5)]' : 'bg-gray-300 dark:bg-gray-600'}`}
                            />
                            {previewMode === 'live' ? 'Live Preview' : 'Edit Only'}
                        </button>

                        {error && (
                            <span className="text-xs mr-4" style={{ color: 'var(--kanban-danger)' }}>
                                {error}
                            </span>
                        )}
                        <button
                ...
                <div
                    className="flex-1 flex flex-col overflow-y-auto p-6 space-y-8"
