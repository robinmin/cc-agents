...
description: "Component design patterns: button states, form design, card layouts, navigation patterns, container queries, and accessible component structures."
license: Apache-2.0
version: 1.1.0
created_at: 2026-03-23
updated_at: 2026-03-25
type: reference
tags: [ui-ux, components, buttons, forms, cards, navigation, layout, container-queries]
metadata:
  author: cc-agents
...
Common UI components with accessibility requirements.
