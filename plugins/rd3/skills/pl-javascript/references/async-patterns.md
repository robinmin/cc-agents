---
name: async-patterns
description: "Comprehensive guide to JavaScript asynchronous programming: Promises, async/await, error handling, parallel execution, and SOTA patterns."
see_also:
  - rd3:pl-javascript
  - rd3:pl-typescript
---
...
async function fetchWithRetry(url, retries = 3, delay = 1000) {
  for (let i = 0; i < retries; i++) {
    try {
      ...
      logger.log(`Retrying... (${retries - i - 1} attempts left)`);
