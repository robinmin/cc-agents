...
description: "Complete guide to property-based testing: test invariants across hundreds of random inputs using Hypothesis, fast-check, and QuickCheck, plus AI-augmented property discovery."
license: Apache-2.0
version: 1.1.0
created_at: 2026-03-23
updated_at: 2026-03-25
tags: [testing, property-based-testing, hypothesis, fast-check, ai-augmented]
metadata:
  author: cc-agents
...
see_also:
  ...
  - rd3:advanced-testing/references/mutation-testing-guide
---
