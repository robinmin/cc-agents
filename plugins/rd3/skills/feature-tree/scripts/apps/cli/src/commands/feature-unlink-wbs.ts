...
export class FeatureUnlinkWbsCommand extends Command {
    constructor() {
        super();
    }

    static paths = [['unlink-wbs']];

    static usage = Command.Usage({
        category: 'Feature Tree',
        description: 'Unlink WBS task IDs from a feature',
        examples: [
            ['Unlink single WBS', 'ftree unlink-wbs abc123 --wbs 001'],
            ['Unlink multiple WBS', 'ftree unlink-wbs abc123 --wbs 001,002'],
        ],
    });
