...
description: "Testing anti-patterns guide: 10 patterns with gate functions, red flags checklist, and the iron laws of testing."
license: Apache-2.0
version: 1.0.0
created_at: 2026-03-23
updated_at: 2026-03-23
platform: rd3
tags: [testing, anti-patterns, tdd, engineering-core]
metadata:
  author: cc-agents
...
see_also:
  - rd3:tdd-workflow
  - rd3:sys-debugging
  - rd3:tdd-workflow/references/mock-patterns
---

# Testing Anti-Patterns

Comprehensive guide to testing anti-patterns with gate functions.
...
- Brittle tests that do not verify user-visible behavior
...
- Does not verify real integration behavior
...
test('calculates sum', () => {
  expect(sum(2, 3)).toBe(5);  // Fails: sum does not exist yet
});
