---
name: estimation
description: "Task estimation techniques: PERT, T-shirt sizing, time-boxing, historical analysis, and expert judgment with formulas and use-case guidance."
see_also:
...
**Formula:**
```
Estimated = (Optimistic + 4 x Likely + Pessimistic) / 6
```
...
Estimated = (40 + 4x60 + 100) / 6
           = (40 + 240 + 100) / 6
           = 380 / 6
           = 63.3 hours

Add buffer (50% for complexity): 63.3 x 1.5 = ~95 hours
```
...
Estimated: (16 + 4x24 + 32) / 6 = 24 hours
```
