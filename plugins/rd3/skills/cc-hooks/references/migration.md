---
name: hook-migration
description: "Guide for migrating from basic command hooks to advanced prompt-based hooks: why migrate, how to convert scripts to prompts, when to keep command hooks, and hybrid approaches."
see_also:
  - rd3:cc-hooks
...
How to migrate from basic command hooks to advanced prompt-based hooks for better maintainability and flexibility.
