...
description: "TypeScript security patterns: input validation, SQL injection prevention, XSS prevention, authentication, RBAC, secrets management, and security headers."
license: Apache-2.0
version: 1.0.0
created_at: 2026-03-23
updated_at: 2026-03-23
tags: [typescript, security, validation, authentication, sql-injection, xss, rbac, engineering-core]
metadata:
  author: cc-agents
