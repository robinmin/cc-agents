---
name: vite-config-patterns
description: "Vite configuration patterns for TypeScript: path aliases, multiple entry points, library mode, SSR, environment variables, proxy, CSS modules, and plugin configuration."
license: Apache-2.0
version: 1.0.0
created_at: 2026-03-23
updated_at: 2026-03-23
tags: [typescript, vite, build-configuration, ssr, proxy, environment-variables, architecture-design]
metadata:
  author: cc-agents
