---
name: golang-project-plan-template
description: "Planning output template for Go projects: sections, fields, and example structure."
see_also:
  - rd3:pl-golang
...
|---------|---------|---------|--------|
| Web Framework | net/http (stdlib) or gin | latest | Native or fast router |
| ORM | sqlx or database/sql | stdlib | Stdio-first |
| Logging | log/slog | 1.21+ stdlib | Structured logging |
...
- Use `sync.WaitGroup` or `sync/errgroup` for waiting
