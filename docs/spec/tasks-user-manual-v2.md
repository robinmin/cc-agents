...
- **View Columns**: Backlog, Todo, WIP, Testing, Done.
- **Track Progress**: Real-time updates as agents move phases.
- **Inspect Artifacts**: Click tasks to view implementation files and logs.
...
*End of User Manual. v2.1.0 — Generated by Antigravity — 2026-04-04.*
